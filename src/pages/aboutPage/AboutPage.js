    ...
    <Section aria-label="About Page">
        ...
        <WalletCard>
            <Ul>
                ...
                <H4>12.02.2022</H4>
                <Li>[x] Make every other CoinContainer have different background color (looked bad) </Li>
                <Li>[√] Loading screen now has loading animation </Li>
                <Li>[√] Loading screen is now larger in height (prevents the container from sudden growth when coins are loaded)</Li>
                <Li>[√] Refactored CoinCard component </Li>
                <Li>[√] Refactored folder structure </Li>
                ...
                <H4>21.01.2022</H4>
                <Li>[√] Make plan for new way to render coins</Li>
                <br />
